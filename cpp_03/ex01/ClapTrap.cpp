...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/04 13:39:56 by aabashee          #+#    #+#             */
/*   Updated: 2024/07/04 13:39:58 by aabashee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::beRepaired(unsigned int count)
{
	if (this->energyPoint > 0)
	{
		std::cout << "ClapTrap " << name << " is repaired " << count << " of hit point!" << std::endl;
		this->hitPoint += count;
		this->energyPoint--;
	}
	else
