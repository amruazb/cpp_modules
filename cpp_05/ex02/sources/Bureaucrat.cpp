...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/04 22:51:11 by aabashee          #+#    #+#             */
/*   Updated: 2024/11/04 22:51:13 by aabashee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(AForm const & form)
{
	...
	{
		std::cout << "Bureaucrat " << _name << " cannot execute " << form.getName() << " because " << e.what() << std::endl;
	}
}
